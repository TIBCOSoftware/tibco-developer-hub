...
echo "---------------  Removing Flogo from a Dataplane ------------------------";
...
echo "Runnning command:|tibcop tplatform:delete-capability-instance --id FLOGO --dataplane-name=\"$DP_NAME\" --debug --profile \"$profile\"|"
tibcop tplatform:delete-capability-instance --id FLOGO --dataplane-name="$DP_NAME" --debug --profile "$profile"

echo "Capability instances in the dataplane (After removing Flogo):"
tibcop tplatform:list-capability-instances --dataplane-name="$DP_NAME" --profile "$profile"
