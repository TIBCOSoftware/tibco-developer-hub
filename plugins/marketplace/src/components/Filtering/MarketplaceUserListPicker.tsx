...
/**
 * A sidebar picker that lets users switch between "All" and "Starred"
 * marketplace entries.  Mirrors the look and behaviour of the
 * {@link TemplateUserListPicker} in the custom-template-flow plugin.
 */
export const MarketplaceUserListPicker = () => {
  ...
  // Reset to "all" if the last starred entry is un-starred.
  useEffect(() => {
  ...
  return (
    <Card data-testid="marketplace-user-list-picker" className={classes.root}>
      <Typography
        variant="subtitle2"
        component="span"
        className={classes.title}
      >
        {t('userListPicker.personalFilter.title')}
      </Typography>
      ...
      <Card className={classes.groupWrapper}>
        <List disablePadding dense>
          ...
          >
            <ListItemText>
              <Typography variant="body1">
                {t('userListPicker.orgFilterAllLabel')}
              </Typography>
            </ListItemText>
